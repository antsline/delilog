-- Row Level Security (RLS) ポリシー設定（修正版）
...
DROP POLICY IF EXISTS "Users can view own tenko records" ON tenko_records;
DROP POLICY IF EXISTS "Users can insert own tenko records" ON tenko_records;
DROP POLICY IF EXISTS "Users can update own tenko records" ON tenko_records;
DROP POLICY IF EXISTS "Users can delete own tenko records" ON tenko_records;
